                            ...
                            <tbody>
                                {menu && menu.map((menu, index) => (
                                    <tr key={menu.id_menu} className="bg-white border-b hover:bg-gray-50">
                                        <td>
                                            <img className="h-auto max-w-[100%]" src={`http://localhost:8080/${splitPath(menu.gambar)}`} alt="product" />
                                        </td>
                                        ...
                                        <td className="pl-6 py-4 text-right">
                                            <a href={`edit_menu/${menu.id_menu}`} className="font-medium text-blue-600 hover:underline">
                                                Edit
                                            </a>
